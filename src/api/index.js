...
// 修改管理员2
export const updateAdmin2 = p => {
    p.status = Number(p.status);
    return put("/admin/update", p);
};
// 退出
...
// 区块链
export const queryHistory = id => get(`/fabric/queryHistoryInfo/${id}`, null);


/* 图 */

// 获取本地中国地图geojson
export const getChinaMap = () => localGet("http://124.223.48.82:8080/backend/map/china.json");

// 获取成都地图的geojson
export const getChenDuMap = () => localGet("http://124.223.48.82:8080/backend/map/ChenDu.json");
